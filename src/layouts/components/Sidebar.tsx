...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-50 flex w-[290px] flex-col justify-between
          border-r border-white/5 bg-[#090909] px-6 py-8
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-xl text-zinc-400 hover:bg-white/10 hover:text-white transition lg:hidden"
        >
          <X size={18} />
        </button>
        ...
        <div>
          ...
          <div className="flex items-center gap-4 px-2">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 mt-1">Productivity Workspace</p>
            </div>
          </div>
        ...
        {/* PRO CARD */}
        <div className="rounded-3xl border border-white/10 bg-bg-card p-6 overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <h2 className="mt-6 text-xl font-bold leading-snug">Upgrade to Pro</h2>
