...
import { AlarmClock, CheckCircle2, MessageSquare } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div className="min-w-0 flex-1">
                <p className={`text-sm leading-snug ${notification.isRead ? "text-zinc-400" : "text-zinc-100 font-medium"}`}>
                    {notification.title}
                </p>
